                  ...
                  child: Column(
                    ...
                    children: [
                      _buildPrivacySection(
                        '🐾 1. ข้อมูลที่เก็บ (Information We Collect)',
                        '• ข้อมูลผู้ใช้: ชื่อ, อีเมล, เบอร์โทร\n'
                        '• ข้อมูลสัตว์เลี้ยง: ชื่อสัตว์, สายพันธุ์, อายุ, ประวัติสุขภาพ\n'
                        '• ข้อมูลการใช้งาน: การจองบริการ, การใช้งานแอป\n'
                        '• ข้อมูลอุปกรณ์: IP Address, Device, Cookies',
                      ),

                      _buildPrivacySection(
                        '🐶 2. วัตถุประสงค์ในการใช้ข้อมูล (How We Use Your Information)',
                        '• ให้บริการดูแลสัตว์เลี้ยง เช่น การจองคิวหรือพบสัตวแพทย์\n'
                        '• ปรับปรุงระบบและประสบการณ์การใช้งานแอป\n'
                        '• ติดต่อผู้ใช้ เช่น แจ้งเตือน หรือโปรโมชั่น\n'
                        '• วิเคราะห์การใช้งานเพื่อพัฒนาบริการ',
                      ),

                      _buildPrivacySection(
                        '🔐 3. การเก็บรักษาและความปลอดภัย (Data Security)',
                        '• ใช้มาตรการรักษาความปลอดภัยของข้อมูล เช่น การเข้ารหัส (Encryption)\n'
                        '• จำกัดการเข้าถึงข้อมูลเฉพาะผู้ที่เกี่ยวข้อง\n'
                        '• เก็บข้อมูลเฉพาะที่จำเป็นต่อการให้บริการ',
                      ),

                      _buildPrivacySection(
                        '🔄 4. การเปิดเผยข้อมูล (Data Sharing)',
                        '• อาจมีการแชร์ข้อมูลกับคลินิกสัตวแพทย์ที่เกี่ยวข้อง\n'
                        '• ผู้ให้บริการชำระเงิน\n'
                        '• เราจะไม่ขายข้อมูลส่วนตัวให้บุคคลที่สาม',
                      ),

                      _buildPrivacySection(
                        '🐕 5. สิทธิของผู้ใช้ (User Rights)',
                        '• ผู้ใช้สามารถขอเข้าถึงข้อมูลของตนเอง\n'
                        '• ขอแก้ไข หรือ ลบข้อมูล\n'
                        '• ถอนความยินยอมในการใช้ข้อมูลได้',
                      ),

                      _buildPrivacySection(
                        '🍪 6. Cookies',
                        '• ใช้ Cookies เพื่อปรับปรุงประสบการณ์การใช้งาน\n'
                        '• ผู้ใช้สามารถตั้งค่าเบราว์เซอร์เพื่อปิดการใช้ Cookies ได้',
                      ),

                      _buildPrivacySection(
                        '📅 7. การเปลี่ยนแปลงนโยบาย (Policy Updates)',
                        '• บริษัทมีสิทธิปรับปรุงนโยบายความเป็นส่วนตัว\n'
                        '• หากมีการเปลี่ยนแปลง จะมีการแจ้งให้ผู้ใช้ทราบผ่านแอปหรือเว็บไซต์',
                      ),

                      _buildPrivacySection(
                        '📞 8. ช่องทางติดต่อ (Contact Us)',
                        '• อีเมล: support@petcareapp.com\n'
                        '• โทร: 02-000-0000\n'
                        '• บริษัท PetCare Application',
                      ),
                    ],
                  ),
                ),
